...
parser.add_argument("--checkpoint_dir", default="checkpoint", type=str, help="directory to store checkpoint files in; if dir already has ckpt files and user didn't specity a differnt ckpt dir to reload from (via relaod_checkpoint), we will reload latest ckptfile in this dir")
