...
parser.add_argument("--ckpt_dir", default="/lus/grand/projects/SuperBERT/mansisak/attn_lens_ckpts/gpt2-small/", type=str, help="path to dir containing all latest ckpts for a model")
parser.add_argument("--save_dir", default="/lus/grand/projects/SuperBERT/mansisak/extracted_lenses/gpt2-small/", type=str, help="path to dir where script should save all extracted lenses")
